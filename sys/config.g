...
M350 C8 I0	 					; Configure tool-changer microstepping without interpolation
M350 E16:16:16:16 I1					; Configure extruder microstepping with interpolation
M350 X16 Y16 Z16 I1					; Configure motion-system microstepping with interpolation
M92 X100 Y100 Z1600 C100 E394:394:395:395		; Set steps per mm
M566 X400 Y400 Z16 C2 E2:2:2:2				; Set maximum instantaneous speed changes (mm/min)
...
M906 X1200 Y1200 Z1330 C400 E1000:1000:1000:1000 I30 	; Set motor currents (mA) and motor idle factor in percent
...
M376 H4					; Taper off bed compensation over H (height in millimeters)

;tool offsets
G10 P0 X24.000 Y44.500 Z-5.689		; T0
G10 P1 X24.620 Y44.807 Z-5.522		; T1
G10 P2 X23.545 Y44.000 Z-5.62		; T2
G10 P3 X23.880 Y44.691 Z-5.879		; T3
